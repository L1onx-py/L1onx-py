...
Atualmente estou aprofundando meus conhecimentos em desenvolvimento de soluções voltadas para análise de dados, automação de processos e aplicações práticas de IA.

Tenho interesse em transformar dados em insights úteis, automatizar tarefas repetitivas e desenvolver projetos que resolvam problemas reais de forma eficiente.
...
* Construir projetos práticos na área de dados
* Evoluir em automação e IA
